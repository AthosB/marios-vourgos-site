...
export const paintingsEntries = [
  {position: 1, src: '/images/paintings/img-001.jpg', alt: 'Painting 1', title: 'Eternity', description: 'Acrylics on canvas - 148 cm x 105 cm'},
  {position: 1, src: '/images/paintings/img-002.jpg', alt: 'Painting 2', title: 'The ecstatic renaissance of life', description: 'Acrylics on canvas - 148 cm x 105 cm'},
  {position: 1, src: '/images/paintings/img-003.jpg', alt: 'Painting 3', title: 'The seduction of spring', description: 'Acrylics on canvas - 118 cm x 84cm'},
  {position: 1, src: '/images/paintings/img-004.jpg', alt: 'Painting 4', title: '"The future awaits" said the bird', description: 'Acrylics on canvas - 115 cm x 95 cm'},
  {position: 1, src: '/images/paintings/img-005.jpg', alt: 'Painting 5', title: 'Zen in the garden of roses', description: 'Acrylics on canvas - 118 cm x 84cm'},
  {position: 1, src: '/images/paintings/img-006.jpg', alt: 'Painting 6', title: 'Awaiting hope', description: 'Acrylics on canvas - 115 cm x 80cm'},
  {position: 1, src: '/images/paintings/img-007.jpg', alt: 'Painting 7', title: 'Unconscious memories of self I', description: 'Acrylics on canvas - 80 cm x 60 cm'},
  {position: 1, src: '/images/paintings/img-008.jpg', alt: 'Painting 8', title: 'Unconscious memories of self II', description: 'Acrylics on canvas - 80 cm x 60 cm'},
  {position: 1, src: '/images/paintings/img-009.jpg', alt: 'Painting 9', title: 'The protection II', description: 'Acrylics on canvas - 160 cm x 120 cm'},
  {position: 1, src: '/images/paintings/img-010.jpg', alt: 'Painting 10', title: 'Life', description: 'Acrylics & crayons on canvas - 160 cm x 120 cm'},
  {position: 1, src: '/images/paintings/img-011.jpg', alt: 'Painting 11', title: 'Conception II', description: 'Acrylics on canvas - 148 cm x 105 cm'},
  {position: 1, src: '/images/paintings/img-012.jpg', alt: 'Painting 12', title: 'Summer is a glance at infinity', description: 'Acrylics on canvas - 120 cm x 90 cm'},
  {position: 1, src: '/images/paintings/img-013.jpg', alt: 'Painting 13', title: 'The temptation of innocence', description: 'Acrylics on canvas - 130 cm x 105 cm'},
  {position: 1, src: '/images/paintings/img-014.jpg', alt: 'Painting 14', title: 'Spring is a glance at the future I', description: 'Acrylics on canvas - 80 cm x 60 cm'},
  {position: 1, src: '/images/paintings/img-015.jpg', alt: 'Painting 15', title: 'Spring is a glance at the future II', description: 'Acrylics on canvas - 80 cm x 60 cm'},
  {position: 1, src: '/images/paintings/img-016.jpg', alt: 'Painting 16', title: 'Reflections of the future', description: 'Acrylics on canvas - 120 cm x 90 cm'},
  {position: 1, src: '/images/paintings/img-017.jpg', alt: 'Painting 17', title: 'Wisdom', description: 'Oil, acrylics, & pastels on canvas - 145 cm x 96 cm'},
  {position: 1, src: '/images/paintings/img-018.jpg', alt: 'Painting 18', title: 'Dreaming of daylight through the night', description: 'Acrylics & pastels on canvas - 146 cm x 114cm'},
  {position: 1, src: '/images/paintings/img-019.jpg', alt: 'Painting 19', title: 'Venus in Paris II', description: 'Acrylics on canvas - 100 cm diameter'},
  {position: 1, src: '/images/paintings/img-020.jpg', alt: 'Painting 20', title: 'The whispering of dreams to come', description: 'Acrylics on canvas - 130 cm x 105 cm'},
  {position: 1, src: '/images/paintings/img-021.jpg', alt: 'Painting 21', title: 'Life II', description: 'Acrylics on canvas - 130 cm x 105 cm'},
  {position: 1, src: '/images/paintings/img-022.jpg', alt: 'Painting 22', title: 'Conception II', description: 'Acrylics on canvas - 130 cm x 105 cm'},
  {position: 1, src: '/images/paintings/img-023.jpg', alt: 'Painting 23', title: 'Contemplating herself', description: 'Acrylics on canvas - 130 cm x 105 cm'},
  {position: 1, src: '/images/paintings/img-024.jpg', alt: 'Painting 24', title: 'Whispering hope', description: 'Acrylics on canvas - 135 cm x 105 cm'},
  {position: 1, src: '/images/paintings/img-025.jpg', alt: 'Painting 25', title: 'Temptation', description: 'Acrylics on canvas - 135 cm x 105 cm'},
  {position: 1, src: '/images/paintings/img-026.jpg', alt: 'Painting 26', title: 'Infinity II', description: 'Acrylics on canvas - 135 cm x 105 cm'},
  {position: 1, src: '/images/paintings/img-027.jpg', alt: 'Painting 27', title: 'Athena', description: 'Acrylics on canvas - 135 cm x 105 cm'},
  {position: 1, src: '/images/paintings/img-028.jpg', alt: 'Painting 28', title: 'The bird and the spider', description: 'Oil, acrylics & pastels on canvas - 160 cm x 120 cm'},
  {position: 1, src: '/images/paintings/img-029.jpg', alt: 'Painting 29', title: '"The future awaits" said the flower', description: 'Oil, acrylics & pastels on canvas - 162 cm x 113 cm'},
  {position: 1, src: '/images/paintings/img-030.jpg', alt: 'Painting 30', title: '...remembering herself', description: 'Oil, acrylics & pastels on canvas - 120 cm x 100 cm'},
  {position: 1, src: '/images/paintings/img-031.jpg', alt: 'Painting 31', title: 'Euphoria', description: 'Oil, acrylics & pastels on canvas - 102 cm x 76 cm'},
  {position: 1, src: '/images/paintings/img-032.jpg', alt: 'Painting 32', title: 'Romeo and Juliet', description: 'Oil & acrylics on canvas - 102 cm x 76 cm'},
  {position: 1, src: '/images/paintings/img-033.jpg', alt: 'Painting 33', title: 'Always summer', description: 'Mixed media on canvas - 120 cm x 100 cm'},
  {position: 1, src: '/images/paintings/img-034.jpg', alt: 'Painting 34', title: 'The flower that fell in love with a woman', description: 'Oil on canvas - 77 cm x 51 cm'},
  {position: 1, src: '/images/paintings/img-035.jpg', alt: 'Painting 35', title: 'Infinity', description: 'Acrylics & pastels on canvas - 120 cm x 90 cm'},
  {position: 1, src: '/images/paintings/img-036.jpg', alt: 'Painting 36', title: 'Memories of a summer gone by', description: 'Oil & acrylics on canvas - 130 cm x 96 cm'},
  {position: 1, src: '/images/paintings/img-037.jpg', alt: 'Painting 37', title: 'Epiphany', description: 'Oil, acrylics & pastels on canvas - 102 cm x 76 cm'},
  {position: 1, src: '/images/paintings/img-038.jpg', alt: 'Painting 38', title: 'The torture of spring', description: 'Oil, acrylics @ watercolours on canvas - 46 cm x 36 cm'},
  {position: 1, src: '/images/paintings/img-039.jpg', alt: 'Painting 39', title: 'The triumph of illusions', description: 'Acrylics on canvas - 55 cm x 45 cm'},
  {position: 1, src: '/images/paintings/img-040.jpg', alt: 'Painting 40', title: 'The falling angel', description: 'Oil on canvas - 77 cm x 61 cm'},
  {position: 1, src: '/images/paintings/img-041.jpg', alt: 'Painting 41', title: 'Epigraph', description: 'Oil, acrylics & pastels on canvas - 102 cm x 76 cm'},
  {position: 1, src: '/images/paintings/img-042.jpg', alt: 'Painting 42', title: 'Apollo and Daphne', description: 'Oil & acrylics on canvas - 102 cm x 76 cm'},
  {position: 1, src: '/images/paintings/img-043.jpg', alt: 'Painting 43', title: 'Angels remembering themselves', description: 'Oil & acrylics on canvas - 102 cm x 76 cm'},
  {position: 1, src: '/images/paintings/img-044.jpg', alt: 'Painting 44', title: 'The instinct of rebirth', description: 'Oil, acrylics & pastels on canvas - 102 cm x 76 cm'},
  {position: 1, src: '/images/paintings/img-045.jpg', alt: 'Painting 45', title: 'The rock that started to feel', description: 'Burned oil on canvas - 61 cm x 46 cm'},
  {position: 1, src: '/images/paintings/img-046.jpg', alt: 'Painting 46', title: 'Venus in Paris', description: 'Oil, acrylics & pastels on canvas - 130 cm x 96 cm'},
  {position: 1, src: '/images/paintings/img-047.jpg', alt: 'Painting 47', title: 'Venus in winter thinking of summer', description: 'Oil & acrylics on canvas - 75 cm x 40 cm'},
  {position: 1, src: '/images/paintings/img-048.jpg', alt: 'Painting 48', title: 'The endless straggle', description: 'Oil, acrylics & pastels on canvas - 120 cm x 100 cm'},
  {position: 1, src: '/images/paintings/img-049.jpg', alt: 'Painting 49', title: 'Together we view the world as one', description: 'Acrylics & watercolors on canvas - 50 cm x 38 cm'},
  {position: 1, src: '/images/paintings/img-050.jpg', alt: 'Painting 50', title: 'In the web of stability', description: 'Oil & acrylics on canvas - 92 cm x 67 cm'},
  {position: 1, src: '/images/paintings/img-051.jpg', alt: 'Painting 51', title: 'The secret life of plants', description: 'Oil & acrylics on canvas - 120 cm x 87 cm'},
  {position: 1, src: '/images/paintings/img-052.jpg', alt: 'Painting 52', title: 'The tree and the spirit', description: 'Oil & acrylics on canvas - 60 cm x 50 cm'},
  {position: 1, src: '/images/paintings/img-053.jpg', alt: 'Painting 53', title: 'The escape of dreams', description: 'Oil, acrylics & pastels on canvas - 120 cm x 100 cm'},
  {position: 1, src: '/images/paintings/img-054.jpg', alt: 'Painting 54', title: 'The woman that fell in love with a flower', description: 'Oil on canvas - 46 cm x 36 cm'},
  {position: 1, src: '/images/paintings/img-055.jpg', alt: 'Painting 55', title: 'The Archangel of regret', description: 'Oil  on canvas - 102 cm x 76 cm'},
  {position: 1, src: '/images/paintings/img-056.jpg', alt: 'Painting 56', title: 'The Archangel of silence', description: 'Oil, acrylics & pastels on canvas - 102 cm x 76 cm'},
  {position: 1, src: '/images/paintings/img-057.jpg', alt: 'Painting 57', title: 'Conception', description: 'Oil, acrylics & pastels on canvas - 102 cm x 76 cm'},
  {position: 1, src: '/images/paintings/img-058.jpg', alt: 'Painting 58', title: 'Morning promises', description: 'Acrylics on canvas - 118 cm x 83 cm'},
  {position: 1, src: '/images/paintings/img-059.jpg', alt: 'Painting 59', title: 'Afternoon escape', description: 'Acrylics on canvas - 118 cm x 83 cm'},
  {position: 1, src: '/images/paintings/img-060.jpg', alt: 'Painting 60', title: 'Evening reminiscing of day', description: 'Acrylics on canvas -  118 cm x 83 cm'},
  {position: 1, src: '/images/paintings/img-061.jpg', alt: 'Painting 61', title: 'Eudaimonia', description: 'Acrylics on canvas - 147 cm x 105 cm'},
  {position: 1, src: '/images/paintings/img-062.jpg', alt: 'Painting 62', title: 'Zero is infinity reversed to time (cosmos)', description: 'Acrylics on canvas - 100 cm x 67 cm'},
  {position: 1, src: '/images/paintings/img-063.jpg', alt: 'Painting 63', title: '...remembering himself', description: 'Acrylics on canvas -  100 cm x 67 cm'},
  {position: 1, src: '/images/paintings/img-064.jpg', alt: 'Painting 64', title: 'The Stare of things to come... (Demian)', description: 'Acrylics on canvas - 100 cm x 67 cm'},
  {position: 1, src: '/images/paintings/img-065.jpg', alt: 'Painting 65', title: 'The deception of Spring (Portrait of Tamara De Lempika)', description: 'Acrylics on canvas - 118.5 cm x 97.5 cm'},
];